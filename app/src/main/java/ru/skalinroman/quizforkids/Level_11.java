...
public class Level_11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDescriptionEnd.setText(R.string.level_11_end);
        ...
        button_continue_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level_11.this, Level_12.class); // Менять переход на новый уровень тут
        ...
        img_left.setImageResource(array.images11[numberLeft]); // Достаем из массива картинку
        ...
        img_right.setImageResource(array.images11[numberRight]); // Достаем из массива картинку
