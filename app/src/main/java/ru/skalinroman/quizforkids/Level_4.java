...
public class Level_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level_4.this, GameLevels.class); // Создаем намерение для перехода
        ...
        numberLeft = random.nextInt(20); // Генерируем случайное число от 0 до 9
        ...
        numberRight = random.nextInt(20); // Генерируем случайное число от 0 до 9
