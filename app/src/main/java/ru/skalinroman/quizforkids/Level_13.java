...
public class Level_13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDescriptionEnd.setText(R.string.level_13_end);
        ...
        button_continue_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level_13.this, Level_14.class); // Менять переход на новый уровень тут
        ...
        img_left.setImageResource(array.images13[numberLeft]); // Достаем из массива картинку
        ...
        img_right.setImageResource(array.images13[numberRight]); // Достаем из массива картинку
