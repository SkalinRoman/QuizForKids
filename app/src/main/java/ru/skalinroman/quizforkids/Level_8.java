...
public class Level_8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDescriptionEnd.setText(R.string.level_eight_end);
        ...
        button_continue_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Level_8.this, Level_9.class); // менять переход на новый уровень тут
        ...
        img_left.setImageResource(array.images8[numberLeft]); // Достаем из массива картинку
        ...
        img_right.setImageResource(array.images8[numberRight]); // Достаем из массива картинку
